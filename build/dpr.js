...
(function (_document, _window) {
    ...
    // 计算dpr
    var navigatorUserAgent = _window.navigator.userAgent; // 获取请求的用户代理头
    var iPhone = navigatorUserAgent.indexOf('iPhone'); // 判断是否是iphone
    var dpr = void 0,
        one_dpr = void 0; // 设备的dpr值和页面的缩放比例
    ...
    // 计算html的字体大小
    var html = _document.getElementsByTagName('html')[0];
    var F0 = 75; // 以iphone6的750 / 10为基准计算
